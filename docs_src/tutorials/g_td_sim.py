...
# some fine-tuning. Example scripts providing working setups are provided [here](https://github.com/GRANADlauncher/granad/tree/main/docs_src/Time%20Domain%20Simulations).
# </div>
